...
class MainWindow(QMainWindow):
    ...
    def _update_context_bar_visibility(self) -> None:
        ...
        show_prompt = (not is_wav_mode) and kind_s == "prompt"
        show_batch_media = (not is_wav_mode) and kind_s == "scenes"
        show_single_wav = (not is_wav_mode) and kind_s == "scene"
    ...
    def _collect_from_ui_impl(self) -> StoryProject:
        ...
        return StoryProject(
            prompt_ko=self._prompt.toPlainText(),
    ...
    def _on_new_project(self) -> None:
        ...
        self._sync_ui_from_project(mark_clean=True, tree_focus=("prompt", 0))
        self.statusBar().showMessage("새 프로젝트", 3000)
